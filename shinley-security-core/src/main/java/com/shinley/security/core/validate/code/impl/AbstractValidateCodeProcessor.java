package com.shinley.security.core.validate.code.impl;
...
import com.shinley.security.core.validate.code.*;
...
public abstract class AbstractValidateCodeProcessor<C extends ValidateCode> implements ValidateCodeProcessor {
    ...
    private C generate(ServletWebRequest request) throws Exception {
        ...
        return (C) validateCodeGenerator.gengrate(request);
    }
    ...
    private String getSessionKey(ServletWebRequest request) {
        return SESSION_KEY_PREFIX + getValidateCodeType(request).name().toUpperCase();
    }
